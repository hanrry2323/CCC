...
- ✅ **Phase 0 环境**：分支 + 测试实例 + 冒烟
- ✅ **Phase 1 实验**：B0-B6 全部完成（25 实验，4 挂账：E16/E17/E18/F23-对比）
- ✅ **Phase 2 落地**：卡2 executors 参数定稿（解挂账）+ 卡3 只读取证首单（待老板核实）
- ✅ **Phase 3 汇总**：`qx-map __archive__/research/dsh-eval-experiments-2026-08-16.md`
- ⏳ 老板动作：核实卡3审计 + 裁决「唯一出口」口径 + 3 处实锤处置
