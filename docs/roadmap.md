...
### clwarp 统一 AI 桌面驾驶舱（2026-08-09 挂账 · clw-plan-001）
...
| **clw004** | 侧边栏点击 CCC 面板显示看板页面 | 已交付 |
| **clw005** | 所有设置可调整并持久化 | 已交付 |
| **clw006** | 打包为 dmg，安装到 /Applications，全链路验收通过 | 已交付 |
| **clw007** | 会话恢复工作目录 + 小缺陷修复 | 已交付 |

> **下一程意向**：Tauri 2.0 桌面驾驶舱基线已大功告成，dmg 已顺利发布。下一阶段启动 Linux (Ubuntu/AppImage) 多端适配与远程会话中继（WebRTC/SSE）集成。
