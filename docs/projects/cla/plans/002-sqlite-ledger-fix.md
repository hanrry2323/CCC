...
>  关联卡：已归档（原引用 cla016 随 8-24 治理归档，见 docs/archive 与 RETIRED 记录）
...
- [x] `pytest tests/test_scheduler_jobspec.py tests/test_queue_persistence.py -q` 全绿
- [x] kill 进程重建后队列任务不蒸发
- [x] `ruff check src/scheduler/` 无错误
