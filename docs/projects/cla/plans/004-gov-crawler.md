...
> 项目：cla · 编号：cla-plan-004 · 状态：已完成 · 作者：OpenCode · 工具：opencode
> 创建：2026-08-17 · 更新：2026-08-18（cla017 已回写待合入）
>  关联卡：已归档（原引用 cla017 随 8-24 治理归档，见 docs/archive 与 RETIRED 记录）
> 关联方案：无
> 进度：1/1 (100%)
> 里程碑：M2 · 政府药械招采网价格监测
...
- [x] pytest 单测（mock 站点）通过
- [x] 实际站点（四川）手动跑通返回结构化数据
- [x] 登录态落盘/重登逻辑有测试覆盖
- [x] 不触碰电商线（3.x 范围外）
