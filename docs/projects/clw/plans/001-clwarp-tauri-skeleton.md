...
- [ ] clw001: Tauri 骨架能启动，终端能启动 claude 进程并交互
- [ ] clw002: 侧边栏显示所有历史会话，点击可恢复
- [ ] clw003: 侧边栏完整可用，中文界面，Git 变更指示器实时更新
- [ ] clw004: 侧边栏点击 CCC 面板显示看板页面
- [ ] clw005: 所有设置可调整并持久化
- [ ] clw006: 打包为 dmg，安装到 /Applications，全链路验收通过
