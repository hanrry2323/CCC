...
> 项目：xy · 编号：xy-plan-005 · 状态：部分执行 · 作者：Claude（中枢） · 工具：Claude Code
> 批准：老板确认转卡 · 2026-08-17
> 创建：2026-08-17 · 更新：2026-08-17
> 关联卡：xy040, xy041, xy042
> 关联方案：无
> 进度：0/3 (0%)
> 里程碑：M3 · 视频高表现力
> 子项目：3.1 视觉模板库
...
- [ ] ≥6 套视觉模板可渲染出样片，每套风格可区分（视觉抽检通过）
- [ ] 模板参数化落地：同一模板可配置不同配色/动效产出不同效果
- [ ] 每套模板样片纳入 `check_video_quality.py` 基线（码率/时长/分辨率达标）
- [ ] 管线接口不破坏（`contracts.py` 四组 dataclass 对不变）
