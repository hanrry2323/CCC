...
> 项目：ccc · 编号：ccc-plan-017 · 状态：已完成 · 作者：OpenCode · 工具：OpenCode
> 创建：2026-08-10 · 更新：2026-08-10
>  关联卡：已归档（原引用 ccc054, ccc055 随 8-24 治理归档，见 docs/archive 与 RETIRED 记录）
...
- [x] §7 落地：onboarding 含交付收尾章节 + delivery-template，交付物清单可勾选。
- [x] validate-plans.sh 方案级校验生效：构造「卡全关未标完成」方案 → 报错。
- [x] 现有 13 个「卡全关未收尾」方案在 §7 定稿后逐一收尾（或由 §7 执行流程覆盖）。
