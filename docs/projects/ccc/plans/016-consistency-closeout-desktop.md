...
> 项目：ccc · 编号：ccc-plan-016 · 状态：已完成 · 作者：OpenCode · 工具：OpenCode
> 创建：2026-08-10 · 更新：2026-08-10
>  关联卡：已归档（原引用 ccc047, ccc048, ccc049, ccc053 随 8-24 治理归档，见 docs/archive 与 RETIRED 记录）
...
- [x] 卡1：13 个方案状态与看板一致（卡全关→已完成/作废）；orphan 卡入方案关联卡。
- [x] 卡2：roadmap 反映真实状态、含全部业务前缀线路段；无卡指向作废方案；ccc021 归属唯一。
- [x] 卡3：CCCDesktop.app 重建安装成功，启动冒烟通过（含 Markdown 渲染/图表/质感）。
