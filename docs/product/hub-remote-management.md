...
> **⚠ 待核（T31 文档基线收口）** — 本文描述 2026-08-02 重构定稿前的旧架构（M1 对话口 + Mac2017 Hub 编排口双口分离）。
> 现行权威 = [`../INDEX.md`](../INDEX.md) §0：2017 单端 :7788（HTTP 直连，对话/看板/运维/线路图四视图统一入口）；旧双口架构已退役。
> 本文完整重写待后续卡处理。
...
| 看板 / 运维 / 下达 | **CCC Desktop** 侧栏（网页 `#/board` `#/ops` 可用，已恢复 2026-07-31；`#/console` 应急兜底） |
...
- 打开 **2017** `#/console` 做应急排查；`#/board` `#/ops` 可用（已恢复 2026-07-31），日常请用 Desktop 侧栏。
