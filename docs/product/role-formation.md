...
> **⚠ 待核（T31 文档基线收口）** — 本文部分口径（阶段能力包、7 角色 seed）描述 2026-08-02 重构定稿前的旧架构。
> 现行权威 = [`../INDEX.md`](../INDEX.md) §0：薄驱动 Engine + 文档流转 + 看板/HTTP + 2017 单端 + 任意设备壳；执行体注册表见 `server/config/executors.json`（契约 §7）。
> 本文完整重写待后续卡处理。
