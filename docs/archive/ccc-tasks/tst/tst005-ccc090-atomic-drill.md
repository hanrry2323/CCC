# 任务卡 tst005 · ccc090 自测演练卡：new-card.sh 原子化全链验证产物（勿认领勿执行，供环节②归档）（DSH 执行）

> 关联：阶段 3 P1 · 执行体：DSH · 验收：DSH · 状态：作废（测试卡完成使命，长期滞留污染 engine 心跳扫描） · 派发：manual · 项目：tst · 日期：2026-08-25
