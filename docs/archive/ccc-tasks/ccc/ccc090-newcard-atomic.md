...
> 关联：R1-R4 出卡吃单窗三次实锤 · 执行体：DSH · 验收：DSH · 状态：已关闭·机审打回复核） · 派发：engine · 项目：ccc · 日期：2026-08-25
...
机审：通过（被审 412576c0496c）

## 定夺（2026-08-26 · 老板授权外脑按机审推荐执行）
> 处置：选项 A——F1 记为已知限制。原子提交段打破调用方「rc≠0⇒无卡」契约，
> 属白名单外不可就地修；单卡直出不受影响，批量场景留待后续相关卡自然收口。
