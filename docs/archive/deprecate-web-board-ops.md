...
网页 Hub 的 `#/board` `#/ops` 曾是过渡冻结面；**2026-07-21** 起网页 Hub 定位为 **Remote Desktop 壳**（对话反代 M1 sidecar），见 [`../product/hub-remote-management.md`](../product/hub-remote-management.md)。
