...
网页 Hub 的 `#/board` `#/ops` 曾是过渡冻结面；**2026-07-21** 二次纠偏：网页 Hub 仍是 **编排口**（看板/运维），对话远程挂 **M1**，见 [`../product/hub-remote-management.md`](../product/hub-remote-management.md) · [`../product/deprecate-web-hub.md`](../product/deprecate-web-hub.md)。
