# 巡查风险报告 — 2026-08-17-ccc-patrol

> 采集时间: 2026-08-17T23:31:33.785237 · 发现数: 2
...
- 针对 `milestone_progress_xy_a`:
  ```bash
  scripts/new-card.sh --project xy --title "修复：里程碑 xy/a 进度不一致" --related "patrol: 2026-08-17-ccc-patrol"
  ```
- 针对 `status_drift_xy001`:
  ```bash
  scripts/new-card.sh --project xy --title "修复：xy001 状态漂移" --related "patrol: 2026-08-17-ccc-patrol"
  ```