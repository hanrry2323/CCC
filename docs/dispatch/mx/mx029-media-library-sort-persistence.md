# 任务卡 mx029 · media library sort persistence（OpenCode 执行）

> 关联：mx-plan-001 · 执行体：OpenCode · 验收：OpenCode · 状态：已关闭· 派发：engine · 项目：mx · 日期：2026-08-09

## 目标

将媒体库排序状态（按名称/日期/大小排序）持久化到 localStorage 或后端配置，刷新页面后保持用户选择的排序方式。
