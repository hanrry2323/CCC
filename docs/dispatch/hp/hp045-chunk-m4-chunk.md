...
> 关联：hp-plan-022 · 执行体：OpenCode · 验收：OpenCode · 状态：待分派 · 派发：engine · 项目：hp · 日期：2026-08-17
...
- 关联方案摘要：目标：短 chunk 拦截/合并，目标 <15%，提升检索粒度。验收标准：短 chunk 治理完成，验收点可复核（命令/可观察结果）。
